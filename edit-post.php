...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Admin Uhuy | Edit Games</title>
...
<label for="exampleInputEmail1">Games Name</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Games Details</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Games Image</b></h4>
